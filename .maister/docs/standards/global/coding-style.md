...
Strict inward dependencies only. Domain layer has zero NuGet dependencies. Api and Infrastructure are peers, wired together at the composition root.

```
Domain (zero deps) --> Application --> Infrastructure / Api (peers)
```
